    ...
    <section className="relative pt-32 lg:pt-36">
      <Container className="flex flex-col lg:flex-row gap-10 lg:gap-12">
        <div className="absolute w-full lg:w-1/2 inset-y-0 lg:right-0">
          ...
          ></span>{" "}
          <span className="absolute right-4 bottom-12 w-24 h-24 rounded-3xl bg-primery blur-xl opacity-80"></span>
        </div>
        ...
        >
          ...
          <Paragraph className="mt-8">
            Our AI integration solutions are designed to transform your business
            by enhancing efficiency, accelerating processes, and unlocking new
            capabilities. With our cutting-edge AI technology, we help you
            streamline operations, boost productivity, and stay ahead of the
            competition, empowering your business to thrive in a rapidly
            evolving world.
          </Paragraph>
        ...
        <div className="flex flex-1 lg:w-1/2 lg:h-auto relative lg:max-w-none lg:mx-0 mx-auto max-w-3xl">
          <img
            src="https://images.pexels.com/photos/7562271/pexels-photo-7562271.jpeg"
            alt="Hero image"
            width={2350}
            height={2359}
