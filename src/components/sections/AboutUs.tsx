    ...
    <section id="about-us">
      <Container className="flex flex-col md:flex-row gap-10 lg:gap-12 items-center">
        ...
        <div className="w-full md:w-7/12 lg:w-1/2 flex flex-col">
          ...
          <Paragraph>
            Our mission is to empower businesses through advanced artificial
            intelligence solutions that drive efficiency, innovation, and
            sustainable growth. We strive to help our clients harness AI to
