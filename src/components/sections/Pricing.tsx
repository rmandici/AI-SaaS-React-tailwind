import { pricingPlans } from "../../utils/pricing_plan";
            ...
            <div key={key} className="relative group h-full">
              <div className="bg-gradient-to-r from-blue-600 to-violet-600 p-1 rounded-3xl h-full">
                ...
                >
                  {plan.bestValue && (
                    <div
                      className="absolute -top-3 left-1/2 -translate-x-1/2 bg-primary 
                                ...
                                px-3 py-1 rounded-full bg-gradient bg-gradient-to-r from-blue-600 to-violet-600"
                    >
                      Best Value
                    </div>
                  )}
                  ...
                  <p className="mt-4 text-2xl font-semibold text-heading-1">
                    {plan.price}
                  </p>
